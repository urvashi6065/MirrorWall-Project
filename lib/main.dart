          ...
          children: [
            Expanded(
              child: InAppWebView(
                ...
                onProgressChanged: (controller, int progress) => setState(() {
                  setState(() {
                      ...
                      if (provider.s1 == Status.google) {
                        provider.webController!.loadUrl(
                            urlRequest: URLRequest(
                                url: WebUri(
                                    'https://www.google.co.in/search?q=${provider.searchController.text}')));
                      } else if (provider.s1 == Status.yahoo) {
                        provider.webController!.loadUrl(
                            urlRequest: URLRequest(
                                url: WebUri(
                                    'https://in.search.yahoo.com/search?q=${provider.searchController.text}')));
                      } else if (provider.s1 == Status.bing) {
                        provider.webController!.loadUrl(
                            urlRequest: URLRequest(
                                url: WebUri(
                                    'https://www.bing.com/search?q=${provider.searchController.text}')));
                      } else {
                        provider.webController!.loadUrl(
                            urlRequest: URLRequest(
                                url: WebUri(
                                    'https://duckduckgo.com/${provider.searchController.text}')));
                      }
                    },
                                  ...
                                  return ListTile(
                                    onTap: () {
                                      convar.webController!.loadUrl(
                                          urlRequest: URLRequest(
                                              url: WebUri(
                                                  'https://www.google.co.in/search?q=${convar.searchController.text}')));
                                    },
                      ...
                      RadioListTile(
                        ...
                        onChanged: (value) {
                          ...
                          conVar.webController!.loadUrl(
                              urlRequest: URLRequest(
                                  url: WebUri(
                                      'https://in.search.yahoo.com/search${conVar.searchController.text}')));
                        },
                        title: Text(
                          'Yahoo',
                          style: TextStyle(fontWeight: FontWeight.bold),
                      ...
                      RadioListTile(
                        ...
                        onChanged: (value) {
                          ...
                          conVar.webController!.loadUrl(
                              urlRequest: URLRequest(
                                  url: WebUri(
                                      'https://www.bing.com/search?q=${conVar.searchController.text}')));
                        },
                        title: Text(
                          'Bing',
                          style: TextStyle(fontWeight: FontWeight.bold),
                      ...
                      RadioListTile(
                        ...
                        onChanged: (value) {
                          ...
                          conVar.webController!.loadUrl(
                              urlRequest: URLRequest(
                                  url: WebUri(
                                      'https://duckduckgo.com/${conVar.searchController.text}')));
                        },
                        title: Text(
                          'Duck Duck Go',
                          style: TextStyle(fontWeight: FontWeight.bold),
